...
// Background music: browsers block audible autoplay until the user interacts.
// Start the music from the first real click (PIN keypad / any button) and
// keep the top-right button available for pause/play.
